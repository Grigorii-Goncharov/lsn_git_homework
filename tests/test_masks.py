...
def test_mask_card_number(test_string: str, expected: str) -> None:
    assert get_mask_card_number(test_string) == expected
...
def test_mask_account_number(test_account_string: str, expected: str) -> None:
    assert get_mask_account(test_account_string) == expected
